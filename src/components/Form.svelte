<script>
  ...
  const adddata = async () => {
    ...
    if (fields.Email == "") {
      ...
      error.Email = "Please enter valid"
      valid = false
    } else {
      error.Email = ""
    }
...
<div class="absolute inset-5 px-10 pt-20">
  <form
    ...
    class="mx-auto mt-7 flex w-full flex-col items-center rounded-lg bg-gradient-to-r from-cyan-300 to-lime-300  p-10 shadow-lg  lg:w-1/2">
