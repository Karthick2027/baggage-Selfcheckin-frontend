...
{:else}
  <div class="flex flex-col  p-10 lg:flex-row">
    <div class="flex w-full  flex-col gap-5 p-4 lg:w-3/5">
      <div
        class="flex items-center justify-center gap-5 rounded-lg bg-white p-2">
        <div>
          <svg
        ...
        <h1 class="text-base font-semibold text-slate-700  md:text-xl">
          Below are the Respective <strong class="text-blue-800"
            >Counternumber</strong>
          and their Respective
          <strong class="text-blue-800">Baggage Id's</strong>.....
        </h1>
      </div>
      ...
      {#each alldetail as alldetails}
        <div
          ...
          <div class="flex w-1/4 items-center justify-center bg-sky-600">
          ...
          <div
            ...
            <h1 class=" text-base font-semibold text-slate-800 md:text-xl">
              <span class=" text-base text-slate-700 md:text-lg"
                >Baggage Id is :</span>
              {alldetails._id}
            </h1>
          </div>
    ...
    <div class="height w-full p-4 lg:w-2/5">
      <div class="h-full  w-full rounded-lg bg-slate-300 opacity-75 shadow-lg">
        <h1 class="pt-5 text-center text-3xl  font-semibold text-blue-800">
          SUMMARY CARD
        </h1>
        ...
        {:else}
          <h1 class="text-2xl font-bold text-center p-10 text-blue-800">
